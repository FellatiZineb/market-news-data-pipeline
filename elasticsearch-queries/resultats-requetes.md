...
**Nombre total de documents indexés** : 100  
...
* OK Agrégation réalisée sur les 100 documents
...
## Requête 3 : Recherche partielle (Fuzzy / N-gram simulé)

### Objectif

Retrouver **Microsoft** à partir d'une saisie partielle (*"micros"*).
...
* OK 10 documents retrouvés contenant "Microsoft"
* OK Recherche partielle avec **`wildcard`** : pattern `*micros*` trouve tous les mots contenant cette chaîne
* Alternative efficace à n-gram pour la recherche autocomplete
* ATTENTION : wildcard peut être lent sur de gros volumes (utiliser avec modération)
* Temps d'exécution : ~7 ms
* Requête exécutée sur 18 shards répartis

### Capture d'écran
![Requête 3 - Wildcard](./images/Q3.png)
